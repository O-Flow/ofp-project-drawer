  ...
  return <div className={clsx(rss.drawer, styles.projectDrawerView)}>
    <ScrollBar className={clsx(rss.main, 'bottom-margin-12')}>
      <div className={clsx(rss.content, styles.content)}>
        ...
        <RsdInput placeholder='Title' value={''}
                  onChange={v => ''}/>
        <RsdInput placeholder='Description' value={''}
                  onChange={v => ''} rows={4}/>
        <RsdMentions placeholder='Tags' value={''}
                     onChange={v => ''}/>
        ...
        <div className={styles.line}>
          ...
          <RsdSelectableButton label='HP Magic Box' value={false}
                               onChange={v => ''}>
            <div className={rsbStyles.iconHolder} style={{
              right: -1,
              bottom: -26
